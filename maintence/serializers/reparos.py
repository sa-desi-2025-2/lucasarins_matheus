...
class ReparosSerializer(ModelSerializer):
    ...
    class Meta:
        model = Reparos
        fields = [
            'id_reparo', 'id_ativo', 'data_reparo', 'tipo', 'descricao',
            'tempo_parada_hora', 'extensao_vida_util', 'unid_extensao_vida_util',
            'id_usuario', 'roi_calculado', 'custo_total_peca', 'custo_mao_obra',
            'custo_total', 'anexos'
        ]
        read_only_fields = ('data_reparo', 'roi_calculado', 'id_reparo')
